...
def get_calendar(
    property_id, start="2024-12-31T13:00:00.000Z", end="2025-12-30T13:00:00.000Z"
):
    dates = json.loads(
        get_url(f"properties/{property_id}.json?start={start}&end={end}")
    )
